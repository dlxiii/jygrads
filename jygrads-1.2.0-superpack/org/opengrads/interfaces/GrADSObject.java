...
/**
 * Interface for a class used for interacting with a GrADS process.
 *
 * @author Arlindo da Silva <dasilva@alum.mit.edu>
 */

public interface GrADSObject {
     ...
     *
     * @see org.opengrads.interfaces.GrADSObject#rline()
     * @see org.opengrads.interfaces.GrADSObject#rline(int i)
     * @see org.opengrads.interfaces.GrADSObject#rword(int i, int j)
     */
     ...
     * @see org.opengrads.interfaces.GrADSObject#jopen(String fname, String ftype)
     * @see org.opengrads.interfaces.GrADSObject#jopen(String fname, String ftype, int Quiet)
     */
    public HashMap jopen ( String fname );
     ...
     * @see org.opengrads.interfaces.GrADSObject#jopen(String fname,)
     * @see org.opengrads.interfaces.GrADSObject#jopen(String fname, String ftype, int Quiet)
     */
    public HashMap jopen ( String fname, String ftype );
     ...
     * @return HashMap with query info and id of opened file
     * @see org.opengrads.factory.GrADSObject#jopen(String fname)
     * @see org.opengrads.factory.GrADSObject#jopen(String fname, String ftype)
     */
    public HashMap jopen ( String fname, String ftype, int Quiet );
     ...
     * </pre>
     */
    public HashMap jquery ( String args );
     ...
     * @see org.opengrads.factory.GrADSObject#jquery(String)
     */
    public HashMap jquery ( String args, int Quiet );
